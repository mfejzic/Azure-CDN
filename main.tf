...
// check the logs see if metrics are working
...
# block creates storage account for us east 2
...
# enables static website and uploads html/css content
resource "azurerm_storage_account_static_website" "SA_east_static_website" {
  ...
  error_404_document = var.error
  index_document     = var.index                                                     // refers to index file in storage account
